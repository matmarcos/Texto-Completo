...
Now it is possible define our homomorphism $\phi$. Let $K$ be a Lie algebra and $I$ a $K$-module. Let $\vartheta \in \htwo KI$ and suppose  that $I$, as an ideal of $K_\vartheta$, is invariant under derivations. For all $x+a \in  K_{\vartheta}$ and $ d \in \der K_{\vartheta}$  write $d(x+a)=\alpha(x)+\eta(x)+\beta(a)$ with $\alpha \in \der K$ and $\beta \in \der I$. Then define $\phi:\der{K_\vartheta} \to \der K \oplus \der I$ by \begin{equation}{\label{defphi2}}
\phi(d)=(\alpha,\beta).
\end{equation}
...
Now we present the main theorem of this section. Recall that for a Lie algebra $K$, for a $K$-module $I$, and for $\vartheta \in \ztwo K I$, $\indu K I \vartheta$ was defined in Definition \ref{defind}. 
 ...
 \item $\im \phi= \indu K I \vartheta $
  ...
  \end{enumerate}
\end{teo}
\begin{proof} In this proof we will denote the product in $K_\vartheta$ of the $h \in K$ and $a \in I$ just by the action $[h,a]$ of $K$ on $I$, since $[h,a]_\vartheta=[h,a].$
